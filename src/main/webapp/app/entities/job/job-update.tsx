  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterdenemeuygulamaApp.job.home.createOrEditLabel">
            <Translate contentKey="jhipsterdenemeuygulamaApp.job.home.createOrEditLabel">Create or edit a Job</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : jobEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="jobTitleLabel" for="job-jobTitle">
                  <Translate contentKey="jhipsterdenemeuygulamaApp.job.jobTitle">Job Title</Translate>
                </Label>
                <AvField id="job-jobTitle" type="text" name="jobTitle" />
              </AvGroup>
              <AvGroup>
                <Label id="minSalaryLabel" for="job-minSalary">
                  <Translate contentKey="jhipsterdenemeuygulamaApp.job.minSalary">Min Salary</Translate>
                </Label>
                <AvField id="job-minSalary" type="string" className="form-control" name="minSalary" />
              </AvGroup>
              <AvGroup>
                <Label id="maxSalaryLabel" for="job-maxSalary">
                  <Translate contentKey="jhipsterdenemeuygulamaApp.job.maxSalary">Max Salary</Translate>
                </Label>
                <AvField id="job-maxSalary" type="string" className="form-control" name="maxSalary" />
              </AvGroup>
              <AvGroup>
                <Label for="job-task">
                  <Translate contentKey="jhipsterdenemeuygulamaApp.job.task">Task</Translate>
                </Label>
                <AvInput
                  id="job-task"
                  type="select"
              ...
              <AvGroup>
                <Label for="job-employee">
                  <Translate contentKey="jhipsterdenemeuygulamaApp.job.employee">Employee</Translate>
                </Label>
