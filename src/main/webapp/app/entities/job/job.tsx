...
export const Job = (props: IJobProps) => {
  ...
  return (
    <div>
      <h2 id="job-heading">
        <Translate contentKey="jhipsterdenemeuygulamaApp.job.home.title">Jobs</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhipsterdenemeuygulamaApp.job.home.createLabel">Create new Job</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('jhipsterdenemeuygulamaApp.job.home.search')}
                />
        ...
        {jobList && jobList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('jobTitle')}>
                  <Translate contentKey="jhipsterdenemeuygulamaApp.job.jobTitle">Job Title</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('minSalary')}>
                  <Translate contentKey="jhipsterdenemeuygulamaApp.job.minSalary">Min Salary</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('maxSalary')}>
                  <Translate contentKey="jhipsterdenemeuygulamaApp.job.maxSalary">Max Salary</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="jhipsterdenemeuygulamaApp.job.employee">Employee</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterdenemeuygulamaApp.job.home.notFound">No Jobs found</Translate>
            </div>
          )
        )}
      </div>
