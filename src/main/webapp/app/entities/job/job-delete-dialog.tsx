...
export const JobDeleteDialog = (props: IJobDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterdenemeuygulamaApp.job.delete.question">
        <Translate contentKey="jhipsterdenemeuygulamaApp.job.delete.question" interpolate={{ id: jobEntity.id }}>
