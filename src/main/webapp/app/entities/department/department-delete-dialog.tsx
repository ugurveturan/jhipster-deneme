...
export const DepartmentDeleteDialog = (props: IDepartmentDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterdenemeuygulamaApp.department.delete.question">
        <Translate contentKey="jhipsterdenemeuygulamaApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
