...
export const EmployeeDeleteDialog = (props: IEmployeeDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterdenemeuygulamaApp.employee.delete.question">
        <Translate contentKey="jhipsterdenemeuygulamaApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
