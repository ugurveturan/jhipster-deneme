  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterdenemeuygulamaApp.employee.home.createOrEditLabel">
            <Translate contentKey="jhipsterdenemeuygulamaApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : employeeEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <UncontrolledTooltip target="firstNameLabel">
                  <Translate contentKey="jhipsterdenemeuygulamaApp.employee.help.firstName" />
                </UncontrolledTooltip>
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup>
                <Label id="emailLabel" for="employee-email">
                  <Translate contentKey="jhipsterdenemeuygulamaApp.employee.email">Email</Translate>
                </Label>
              ...
              <AvGroup>
                <Label id="salaryLabel" for="employee-salary">
                  <Translate contentKey="jhipsterdenemeuygulamaApp.employee.salary">Salary</Translate>
                </Label>
              ...
              <AvGroup>
                <Label for="employee-manager">
                  <Translate contentKey="jhipsterdenemeuygulamaApp.employee.manager">Manager</Translate>
                </Label>
