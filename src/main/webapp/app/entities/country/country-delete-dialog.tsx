...
export const CountryDeleteDialog = (props: ICountryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterdenemeuygulamaApp.country.delete.question">
        <Translate contentKey="jhipsterdenemeuygulamaApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
