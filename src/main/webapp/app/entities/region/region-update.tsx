  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterdenemeuygulamaApp.region.home.createOrEditLabel">
            <Translate contentKey="jhipsterdenemeuygulamaApp.region.home.createOrEditLabel">Create or edit a Region</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
