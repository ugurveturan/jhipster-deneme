...
export const RegionDeleteDialog = (props: IRegionDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterdenemeuygulamaApp.region.delete.question">
        <Translate contentKey="jhipsterdenemeuygulamaApp.region.delete.question" interpolate={{ id: regionEntity.id }}>
