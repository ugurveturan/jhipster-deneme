...
export const LocationDeleteDialog = (props: ILocationDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterdenemeuygulamaApp.location.delete.question">
        <Translate contentKey="jhipsterdenemeuygulamaApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
