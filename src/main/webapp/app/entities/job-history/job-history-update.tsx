  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterdenemeuygulamaApp.jobHistory.home.createOrEditLabel">
            <Translate contentKey="jhipsterdenemeuygulamaApp.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : jobHistoryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                >
                  <option value="FRENCH">{translate('jhipsterdenemeuygulamaApp.Language.FRENCH')}</option>
                  <option value="ENGLISH">{translate('jhipsterdenemeuygulamaApp.Language.ENGLISH')}</option>
                  <option value="SPANISH">{translate('jhipsterdenemeuygulamaApp.Language.SPANISH')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
                <Label for="job-history-job">
                  <Translate contentKey="jhipsterdenemeuygulamaApp.jobHistory.job">Job</Translate>
                </Label>
