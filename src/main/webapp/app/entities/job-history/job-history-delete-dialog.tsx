...
export const JobHistoryDeleteDialog = (props: IJobHistoryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterdenemeuygulamaApp.jobHistory.delete.question">
        <Translate contentKey="jhipsterdenemeuygulamaApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
