...
export const TaskDeleteDialog = (props: ITaskDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterdenemeuygulamaApp.task.delete.question">
        <Translate contentKey="jhipsterdenemeuygulamaApp.task.delete.question" interpolate={{ id: taskEntity.id }}>
